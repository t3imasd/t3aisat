...
# Términos y Condiciones de Uso, Política de Privacidad y Descargo de Responsabilidad de T3 AI SAT
...
- Obtener la dirección en texto, según las coordenadas del teléfono móvil.
- Dibujar y mostrar parcelas catastrales en el mapa.

### 5. Base Jurídica para el Tratamiento de Datos

El tratamiento de tus datos personales se basa en:

- **Consentimiento:** Al utilizar la aplicación, aceptas el tratamiento de tus datos conforme a esta **Política de Privacidad**.
- **Intereses Legítimos:** Para mejorar nuestros servicios y ofrecer una mejor experiencia de usuario.
...
Tus datos pueden ser transferidos y almacenados en servidores ubicados fuera del Espacio Económico Europeo (EEE). Nos aseguramos de que dichas transferencias cumplan con las normativas de protección de datos vigentes.
...
Future<String> loadTermsFromFile(BuildContext context) async {
  ...
  try {
    ...
    String content = _termsAndConditions;
    try {
